...
<body><div class="container"><div style="max-width:600px; padding:30px; border:1px solid #ddd; border-left:5px solid #dc3545;">
    ...
    <p>Anda yakin ingin menghapus data mahasiswa <strong><?php echo $mhs['nama_mahasiswa']; ?></strong>? Tindakan ini tidak dapat dibatalkan.</p>
    <form action="hapus_data.php?nim=<?php echo $nim; ?>" method="POST">
